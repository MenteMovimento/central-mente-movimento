...
$DispositivosDir = Join-Path $CentralDir "modules\dispositivos"
...
$processes += Start-LocalProcess -Name "dispositivos" -WorkingDirectory $DispositivosDir -FilePath "npm.cmd" -ArgumentList @("run", "dev", "--", "--host", "127.0.0.1", "--port", "8092") -Environment @{ BROWSER = "none" }
...
Write-Host "Dispositivos corre integrado na Central em /area/dispositivos"
Write-Host ""
...
Write-Host "  Dispositivos: http://127.0.0.1:8090/area/dispositivos"

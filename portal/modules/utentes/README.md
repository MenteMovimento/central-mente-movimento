...
- Area de manuais no menu com escolha entre manual de utilizador e manual de desenvolvedor.
- Manual tecnico completo para desenvolvedores em `MANUAL_DESENVOLVEDOR.md`.
...
```text
api/index.py      Entrada Python serverless para Vercel
vercel.json       Rewrites para encaminhar o site para a funcao Python
```
...
Depois de alterar variaveis de ambiente, faca redeploy para as novas variaveis
serem aplicadas.
...
MANUAL_DESENVOLVEDOR.md Manual tecnico para manutencao futura

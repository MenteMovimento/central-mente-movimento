...
TRANSLATIONS = {
    "pt": {
        ...
        "pending_fee_singular": "1 quota pendente",
        "pending_fee_plural": "{count} quotas pendentes",
...
def render_diagnostica_form(data, readonly=False):
    ...
    <div class="diagnostica-form{readonly_class}">
        ...
        <section class="form-section">
            ...
            <div class="form-grid">
                {render_textarea_input(data, "diag_familiar_outro_texto", "Outro", "span-6", readonly=readonly, rows=4)}
            </div>
        </section>

...
def render_diagram_editor(data, key, title, kind, readonly=False, primary_label=""):
    ...
    if kind == "genograma":
        ...
        legend = """
            ...
            <li><span class="legend-symbol"><svg viewBox="0 0 58 34"><circle cx="29" cy="17" r="16" fill="#fff" stroke="#12805c" stroke-width="2.4"/><circle cx="29" cy="17" r="11" fill="none" stroke="#f3fbf8" stroke-width="2.4"/></svg></span><span class="legend-label">Pessoa índice</span></li>

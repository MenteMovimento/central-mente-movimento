...
const translations = {
  pt: {
    app: {
      ...
      dark: "Escuro",
      light: "Claro",
      darkTitle: "Mudar para tema escuro",
      lightTitle: "Mudar para tema normal",
      newMember: "Novo sócio",
      adminManager: "Gestor de Administradores",
      refresh: "Atualizar",
      close: "Fechar",
      save: "Guardar",
  ...
  en: {
    app: {
      ...
      lightTitle: "Switch to normal theme",
...
function applyPermissions() {
  ...
  elements.exportJsonBtn.hidden = !exportAllowed;

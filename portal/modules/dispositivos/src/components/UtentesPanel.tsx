...
const labels = {
  pt: {
    ...
    savedDemo: 'Utente guardado em modo demonstração.',
    deleted: 'Utente apagado.',
    deletedDemo: 'Utente apagado em modo demonstração.',
    setupRequired:
      'Não foi possível carregar utentes. Confirma se apps/utentes/supabase_schema.sql foi executado no Supabase.',
